/*
 * vga_font.c - Implementacion de fuente bitmap 8x8
 * Fuente estandar PC (codepage 437)
 */
#include "vga_font.h"

/* Fuente bitmap 8x8 - caracteres ASCII 32-127 */
